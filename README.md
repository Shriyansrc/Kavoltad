...
| 36.6–41.6 s | LIVE, light wave, fireworks, devices shoot skyward, crowd cheers; CODE and KEYS tiles; the billboard powers on with the real Sikshaara homepage; the scarf ribbon wipes the frame. **YOUR CODE. YOUR KEYS. → SHIPPED. NOT MOCKED UP.** | Narrator: “On the seventh day, your code and your keys are all yours, ready to go live!” · “Real work. Really shipped.” |
